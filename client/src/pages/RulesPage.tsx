...
function RulesPage() {
  return (
    <main>
      <section className="mt-38 fixed left-1/2 top-1/2 mx-auto mb-8 max-h-[55vh] w-[70%] -translate-x-1/2 -translate-y-1/2 transform overflow-y-auto rounded-xl bg-yellow-p bg-opacity-85 p-8 text-justify text-blue-v md:w-[40%] lg:w-1/3">
